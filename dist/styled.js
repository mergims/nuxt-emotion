...
const ILLEGAL_ESCAPE_SEQUENCE_ERROR = process.env.NODE_ENV === 'production'
  ? ''
  ...
  return function (...args) {
    ...
    const Styled = {
      ...
      render (h, { data, children, parent, injections }) {
        ...
        const _a = data.attrs || {}; const { as, value } = _a; const restAttrs = __rest(_a, ['as', 'value'])
        let className = data.staticClass ? `${data.staticClass} ` : ''
        const finalTag = as || baseTag
        const classInterpolations = []
        const mergedProps = Object.assign(Object.assign(Object.assign({}, data.attrs), { theme: injections.theme }), parent.$evergarden)
        ...
        return h(finalTag, Object.assign(Object.assign({}, data), { attrs: options.getAttrs ? options.getAttrs(restAttrs) : restAttrs, staticClass: undefined, class: className, domProps }), children)
      }
    }
    Styled.name =
    ...
    Styled.withComponent = (nextTag, nextOptions) => {
      return createStyled(nextTag, nextOptions === undefined
        ? options : Object.assign(Object.assign({}, (options || {})), nextOptions))(...styles)
    }
    return Styled
  }
}
